...
public class Constants {
    public static final String API_URL = "https://coronavirus-19-api.herokuapp.com/countries/World";
    public static final String TAG_OUTPUT = "OUTPUT";
    public static final String JSON_PROCESSING_WORK_NAME = "JSON_PROCESSING";
